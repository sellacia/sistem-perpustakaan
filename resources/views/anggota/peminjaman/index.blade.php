...
@section('content')
    ...
    <section class="rounded-3xl border border-slate-200 bg-white shadow-sm">
        ...
        <!-- TABLE WRAPPER (biar bisa scroll horizontal) -->
                    ...
                    @forelse ($peminjaman as $item)
                        <tr class="transition hover:bg-slate-50">
                            ...
                            <td class="px-6 py-4 text-slate-600">
                                ...
                                <!-- Jika sudah dikembalikan tampilkan tanggal, jika belum tampil '-' -->
                                {{ $item->display_tanggal_kembali
                                    ? \Carbon\Carbon::parse($item->display_tanggal_kembali)->format('d M Y')
                                    : '-' }}
                            </td>
