        ...
        <div class="flex items-center justify-between gap-4">
            <div>
                ...
                <p class="mt-2 text-sm text-slate-500">
                    Lengkapi informasi utama agar akun siap digunakan untuk peminjaman buku.
                </p>
            </div>
            ...
            <div class="grid gap-5 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}"
                        class="w-full rounded-2xl border border-slate-200 px-4 py-3 text-sm outline-none transition focus:border-sky-300 focus:ring-4 focus:ring-sky-100"
                        required>
                </div>
