        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-8 flex items-center gap-6">
                <div class="w-28 h-36 bg-white/20 rounded-xl flex items-center justify-center shrink-0 overflow-hidden">
                    @if ($buku->cover)
                        <img src="{{ asset('assets/images/' . basename($buku->cover)) }}"
                ...
                <div class="text-white">
                    ...
                    <div class="mt-3">
                        @if ($buku->status == 'tersedia')
                            <span
                                class="bg-green-400/30 border border-green-300/50 text-white text-xs px-3 py-1 rounded-full font-medium">
                                ✓ Tersedia
                            </span>
                        @else
                            <span
                                class="bg-yellow-400/30 border border-yellow-300/50 text-white text-xs px-3 py-1 rounded-full font-medium">
                                Dipinjam
                            </span>
                        @endif
                    </div>
            ...
            <div class="p-6">
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="bg-gray-50 rounded-xl p-4">
                        ...
                        <p class="font-bold text-xl {{ $buku->stok > 0 ? 'text-green-600' : 'text-red-500' }}">
                            {{ $buku->stok }} buku</p>
                    </div>
                </div>
